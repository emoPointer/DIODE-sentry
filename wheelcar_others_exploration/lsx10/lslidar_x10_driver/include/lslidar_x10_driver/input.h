...
public:
  ...
  virtual int getPacket(lslidar_x10_msgs::LslidarX10PacketPtr& packet) = 0;
...
public:
  ...
  virtual int getPacket(lslidar_x10_msgs::LslidarX10PacketPtr& packet);
...
public:
    ...
    virtual ~InputPCAP();
    virtual int getPacket(lslidar_x10_msgs::LslidarX10PacketPtr& pkt);
private:
